package com.insurance.assured.ui.pages.planslist
...
import com.insurance.assured.ui.pages.planslist.adapters.FiltersAdapter
import com.insurance.assured.ui.pages.planslist.adapters.PlansAdapter
...
class PlanListFragment : BaseFragment<FragmentPlanListBinding>(FragmentPlanListBinding::inflate) {
    ...
    override fun init() {
        ...
        viewModel.getData()
        if(Firebase.auth.currentUser == null){
            binding.chatImage.visibility = GONE
        }
    }
